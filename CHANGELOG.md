...
- A built-package consumer experiment covering public exports with deterministic and real `lean --server` transports, including references and versioned diagnostic recovery.
