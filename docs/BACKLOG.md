...
- Add coverage for formatting, rename, references, and semantic tokens against a real Lean server; hover and versioned diagnostic recovery now have real-server paths.
