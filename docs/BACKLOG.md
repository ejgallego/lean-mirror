...
- Add coverage for formatting and semantic tokens against a real Lean server; hover, references, rename, and versioned diagnostic recovery now have real-server paths.
